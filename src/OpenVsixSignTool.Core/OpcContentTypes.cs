...
namespace OpenVsixSignTool.Core
{
    ...
    public class OpcContentTypes : IList<OpcContentType>
    {
        ...
        private void ProcessElement(OpcContentTypeMode mode, XElement element)
        {
            ...
            {
                case OpcContentTypeMode.Default:
                    _contentTypes.Add(new OpcContentTypeDefault(element.Attribute("Extension").Value, contentType, mode));
                    break;
                case OpcContentTypeMode.Override:
                    var uri = new Uri(element.Attribute("PartName").Value, UriKind.Relative);
                    var partName = UriHelpers.ToQualifiedUri(uri);
